...
# DATA DO CODIGO.: 10/01/2017
# ARQUIVO........: GERAR-REMESSA-BRADESCO-ARQUIVO.PHP
# FINALIDADE.....: GERAR ARQUIVO DE REMESSA DO BRADESCO PADRAO CNAB-240
# LICENCA DE USO.: GPL
######################################################################################################################################################
?>
...
$arq                       = $_REQUEST['arquivo'];                     // nome do seu arquivo de remessa a ser gerado 
...
$valor_multa               = $_REQUEST['pmulta'];                      // MULTA EM PORCENTAGEM CONTENDO 2 CASAS DECIMAIS, P.EX. "200" = 2%
$carteira                  = $_REQUEST['carteira'];                    // CODIGO DA CARTEIRA
$cpf_cnpj                  = $_REQUEST['cnpj'];                        // CNPJ
$agencia                   = $_REQUEST['agencia'];                     // AGENCIA DA CONTA DA EMPRESA
$dv_agencia                = $_REQUEST['dv_agencia'];                  // DIGITO DA AGENCIA
$conta                     = $_REQUEST['conta'];                       // CONTA CORRENTE
$dv_conta                  = $_REQUEST['dv_conta'];                    // DIGITO DA CONTA
$dv_ag_conta               = $_REQUEST['dv_ag_conta'];                 // DIGITO DA AGENCIA/CONTA (VERIFICAR E OBTER COM O SEU BANCO)
$num_banco                 = "237";                                    // '237' = COD. DO BANCO BRADESCO
$nome_banco                = "BRADESCO SA";                            // NOME DO BANCO = BRADESCO SA
$codigo_beneficiario       = $_REQUEST['cod_benef'];                   // COD. BENEFICIARIO OU COD. DO CONVENIO
$conta_cedente             = $_REQUEST['cedente'];                     // COD. DO CEDENTE (OBTER COM O SEU BANCO)
$empresa_beneficiario      = $_REQUEST['nome_empresa'];  // NOME DA EMPRESA

// dados do boleto
$nosso_num                 = $_REQUEST['nosso_numero'];                // NOSSO NUMERO => NUMERO DO SEU BOLETO. P.EX. ==> BOLETO Nº 32244;

$data_vencimento_boleto    = $_REQUEST['dt_vencimento'];              // VENCIMENTO DO BOLETO -> DDMMYYYY
$data_multa                = $_REQUEST['dt_multa'];
$data_emissao_boleto       = $_REQUEST['dt_emissao'];                                    // EMISSAO DO BOLETO -> DDMMYYYY
$valor_boleto              = $_REQUEST['valor_boleto'];                                  // 35000'; //350,00
$data_juros                = $_REQUEST['dt_juros'];                                      // DATA LIMITE PARA COBRAR JUROS E MULTA -> DDMMYYYY
$valor_juros               = $_REQUEST['pjuros'];                                        // JUROS EM TAXA PERCENTUAL 0034 ou 350,00, depende se em valor ou em taxa
$data_desconto             = $_REQUEST['dt_desconto'];                                                 // DATA LIMITE PARA DESCONTO -> DDMMYYYY
$valor_desconto            = $_REQUEST['pdesconto'];                                                      // VALOR DO DESCONTO EM PORCENTAGEM
...
$numero_inscricao_pagador  = $_REQUEST['pag_cpf'];                                              // cpf ou cnpj do pagador
$nome_pagador              = $_REQUEST['pag_nome'];                                           // NOME DO PAGADOR
$endereco_pagador          = $_REQUEST['pag_endereco'];                                // ENDERECO
$bairro_pagador            = $_REQUEST['pag_bairro'];                                           // BAIRRO
$cep_pagador               = $_REQUEST['pag_cep1'];                                                    // PRIMEIROS 5 DIGITOS DO CEP
$cep_pagador_sufixo        = $_REQUEST['pag_cep2'];                                                      // TRES ULTIMOS DIGITOS DO CEP
$cidade_pagador            = $_REQUEST['pag_cidade'];                                                 // CIDADE
$estado_pagador            = $_REQUEST['pag_estado'];                                                       // ESTADO
$email_pagador             = $_REQUEST['pag_email'];                                // EMAIL
