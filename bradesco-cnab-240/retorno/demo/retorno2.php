...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div align="center"><img src="../../../../figuras/logo-big.png" width="350" height="138" /></div></td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td colspan="2" valign="top"><div align="center"><span class="titulo_das_tabelas">ARQUIVOS DE RETORNO - BRADESCO - CNAB 240 </span></div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td height="26" colspan="2" bgcolor="#FFFFFF"><table width="100%" class="tabela_info2">
      <tr>
        <td height="40" colspan="12" valign="middle" bgcolor="#FFCC00"><div align="center" class="titulo_das_tabelas">ARQUIVO DE RETORNO </div></td>
      </tr>
      <tr>
